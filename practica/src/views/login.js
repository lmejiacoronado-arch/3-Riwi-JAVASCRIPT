...
export function loginView() {
    return `
        <div class="auth-container">
            <div class="auth-card">
                <h2>EventMaster</h2>
                <p>Ingresa para gestionar tus suscripciones</p>
        ...
        try {
            ...
            if (userFound) {
                ...
                if (userFound.role === "Admin") {
                    window.location.hash = "#/allEvents"; // Panel para ver todas las reservas
                } else {
                    window.location.hash = "#/events"; // Lista de eventos para suscribirse
                }
            } else {
